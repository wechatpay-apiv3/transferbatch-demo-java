...
public class BatchTransferOrderEntity {
    ...
    public ArrayList<TransferDetailOrderEntity> getTransferDetailOrders() {
        return transferDetailOrders;
    }

    public void setTransferDetailOrders(ArrayList<TransferDetailOrderEntity> transferDetailOrders) {
        this.transferDetailOrders = transferDetailOrders;
    }
}
