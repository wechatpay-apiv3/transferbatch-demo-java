...
public class BatchTransferOrderController {
    ...
    @Autowired
    private BatchTransferOrder batchTransferOrder;
    @Autowired
    private TransferDetailOrder transferDetailOrder;
    ...
    public ResponseMessage createBatch(@RequestBody CreateBatchRequest batchInfo) {
        ...
        batchTransferOrderEntity.setMchid(MerchantConfig.getMerchantId());
        ...
        for (TransferDetailInput item : batchInfo.getTransferDetailList()) {
            ...
            detail.setMchid(MerchantConfig.getMerchantId());
        ...
        return new ResponseMessage("SUCCESS", "发起转账成功");
    }
    ...
    public ResponseMessage queryBatch(@RequestParam String outBatchNo) {
        ...
        return new ResponseMessage("SUCCESS", "", resp);
    }
    ...
    public ResponseMessage queryDetail(@RequestParam String outBatchNo, @RequestParam String outDetailNo) {
        // 1、查询转账明细单
        TransferDetailOrderEntity transferDetailOrderEntity;
        try {
            transferDetailOrderEntity = transferDetailOrder.queryTransferDetailOrder(outBatchNo, outDetailNo);
        } catch (BusinessException e) {
            return new ResponseMessage(e.getCode(), e.getErrMsg());
        }
